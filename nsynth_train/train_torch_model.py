...
from nsynth_train.model_defs import mnist_4_1024
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Trains an mnist model for Nsynth instrument recognition.")

from PaSST.models.passt import PaSST, PatchEmbed, get_model
from PaSST.models.mel_configurable import AugmentMelSTFT
...
class PasstHPO(L.LightningModule):
    def __init__(self, 
...
def cli_main():
    cli = LightningCLI(PasstHPO, AudioSetDataModule) 

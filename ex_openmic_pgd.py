...
from pgd.openmic_pgd import run_pgd_single_sample_openmic, _calc_accuracy
...
def automain(_run, eps, max_iters, alpha, verbose):
    ...
    # Load DataModule
    dm = OpenMICDataModule(batch_size_test=1, test_hdf="/hpcwork/rwth1754/openmic/openmic_test.hdf5")
    dm.setup("test")
